...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,---------------------------------------------------------------------------------------------.     ,---------------------------------------------------------------------------------------------------------.
             _______,     KC_GRV, S(KC_COMM),  S(KC_DOT),    KC_MINS,  S(KC_BSLS),         _______,             _______,       S(KC_6),   S(KC_LBRC),    S(KC_RBRC),        S(KC_4),      XXXXXXX,         KC_MPRV,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+--------------+-------------+--------------+---------------+-------------+----------------|
             _______,    S(KC_1),    S(KC_8),    KC_SLSH,     KC_EQL,     S(KC_7),         _______,             _______,       S(KC_3),      S(KC_9),       S(KC_0),        KC_SCLN,   S(KC_QUOT),         KC_MPLY,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+--------------+-------------+--------------+---------------+-------------+----------------|
             _______,  S(KC_GRV),  S(KC_EQL),    KC_LBRC,    KC_RBRC,     S(KC_5),                                             S(KC_2),   S(KC_SCLN),       KC_COMM,         KC_DOT,      KC_QUOT,         KC_MNXT,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+--------------+-------------+--------------+---------------+-------------+----------------|
  ...
  //,---------------------------------------------------------------------------------------------.     ,---------------------------------------------------------------------------------------------------------.
             _______,      KC_F1,      KC_F2,      KC_F3,      KC_F4,     XXXXXXX,         _______,             _______,     G(KC_GRV), SGUI(KC_GRV), SGUI(KC_LBRC),  SGUI(KC_RBRC),      XXXXXXX,         KC_VOLU,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+--------------+-------------+--------------+---------------+-------------+----------------|
