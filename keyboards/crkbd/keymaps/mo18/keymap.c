...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,---------------------------------------------------------------------------------------------.     ,-------------------------------------------------------------------------------------------------------.
              KC_TAB,    S(KC_1),    S(KC_2),    S(KC_3),    S(KC_4),     S(KC_5),         _______,             _______,      S(KC_6),      S(KC_7),       S(KC_8),       KC_MINS,       KC_EQL,         KC_MPRV,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+-------------+-------------+--------------+--------------+-------------+----------------|
             KC_LCTL, S(KC_LBRC), S(KC_RBRC),    S(KC_9),    S(KC_0),     XXXXXXX,         _______,             _______,      XXXXXXX,       KC_GRV,     S(KC_GRV),    S(KC_MINS),    S(KC_EQL),         KC_MPLY,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+-------------+-------------+--------------+--------------+-------------+----------------|
             KC_LSFT,    XXXXXXX,    XXXXXXX,    KC_LBRC,    KC_RBRC,     XXXXXXX,                                            XXXXXXX,      XXXXXXX,       XXXXXXX,       XXXXXXX,      XXXXXXX,         KC_MNXT,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+-------------+-------------+--------------+--------------+-------------+----------------|
  ...
  //,---------------------------------------------------------------------------------------------.     ,-------------------------------------------------------------------------------------------------------.
              KC_TAB,      KC_F1,      KC_F2,      KC_F3,      KC_F4,     XXXXXXX,         _______,             _______,    G(KC_GRV), SGUI(KC_GRV), SGUI(KC_LBRC), SGUI(KC_RBRC),      KC_BSPC,         KC_VOLU,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+-------------+-------------+--------------+--------------+-------------+----------------|
             KC_LCTL,      KC_F5,      KC_F6,      KC_F7,      KC_F8,     XXXXXXX,         _______,             _______,      KC_LEFT,      KC_DOWN,         KC_UP,      KC_RIGHT,       KC_ENT,         KC_MUTE,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+-------------+-------------+--------------+--------------+-------------+----------------|
             KC_LSFT,      KC_F9,     KC_F10,     KC_F11,     KC_F12,     XXXXXXX,                                            XXXXXXX,      XXXXXXX,       KC_LCBR,       KC_RCBR,      XXXXXXX,         KC_VOLD,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+-------------+-------------+--------------+--------------+-------------+----------------|
                                                             _______,     _______,         _______,             _______,      _______,     _______
                                                         //`--------+------------+----------------'     `--------------+-------------+-------------'
  ),
  ...
  //,---------------------------------------------------------------------------------------------.     ,-------------------------------------------------------------------------------------------------------.
             XXXXXXX,  LCS(KC_6),     XXXXXXX,   XXXXXXX,    XXXXXXX, M_TMX_LASTS,         _______,             _______,    M_TMX_FZF,  M_TMX_PREVS,   M_TMX_NEXTS,   M_TMX_PREVW,  M_TMX_NEXTW,         XXXXXXX,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+-------------+-------------+--------------+--------------+-------------+----------------|
