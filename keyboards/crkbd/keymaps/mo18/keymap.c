...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,---------------------------------------------------------------------------------------------.     ,---------------------------------------------------------------------------------------------------------.
              KC_TAB,      KC_F1,      KC_F2,      KC_F3,      KC_F4,     XXXXXXX,         _______,             _______,     G(KC_GRV), SGUI(KC_GRV), SGUI(KC_LBRC),  SGUI(KC_RBRC),      XXXXXXX,         KC_VOLU,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+--------------+-------------+--------------+---------------+-------------+----------------|
             KC_LCTL,      KC_F5,      KC_F6,      KC_F7,      KC_F8,     XXXXXXX,         _______,            _______,  LT(0,KC_LEFT),      KC_DOWN,         KC_UP, LT(0,KC_RIGHT),      XXXXXXX,         KC_MUTE,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+--------------+-------------+--------------+---------------+-------------+----------------|
             KC_LSFT,      KC_F9,     KC_F10,     KC_F11,     KC_F12,     XXXXXXX,                                             XXXXXXX,      XXXXXXX,    G(KC_LCBR),     G(KC_RCBR),      XXXXXXX,         KC_VOLD,
  //|---------------+-----------+-----------+-----------+-----------+------------+----------------|     |--------------+--------------+-------------+--------------+---------------+-------------+----------------|
                                                             _______,     _______,         _______,             _______,       _______,     _______
                                                         //`--------+------------+----------------'     `--------------+--------------+-------------'
  ),
